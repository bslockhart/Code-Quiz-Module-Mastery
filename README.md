...
## Description
Timed Coding Quiz application that tests knowledge acquired from current module. Application runs in the browser, and features dynamically updated HTML and CSS powered by JavaScript. Application has clean, polished, and responsive user interface.
